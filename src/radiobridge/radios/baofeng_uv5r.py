"""Formatter for Baofeng UV-5R handheld radio."""
...
class BaofengUV5RFormatter(BaseRadioFormatter):
    ...
    the Baofeng UV-5R programming software or CHIRP.

    The UV-5R is a basic dual-band analog radio that supports VHF (136-174 MHz)
    and UHF (400-520 MHz) bands with analog FM operation.
    """

    @property
    def radio_name(self) -> str:
        """Human-readable name of the radio."""
        return "Baofeng UV-5R"

    @property
    def description(self) -> str:
        """Description of the radio and its capabilities."""
        return "Compact dual-band analog handheld radio with VHF/UHF support"
    ...
    def format(
        ...
        """Format repeater data for Baofeng UV-5R.
        ...
        Returns:
            Formatted DataFrame ready for UV-5R programming software
        """
        ...
        for idx, row in data.iterrows():
            ...
            # UV-5R has limited display (6-7 chars typically shown)
            ...
            # Format tone values for UV-5R format
            tone_mode = "None"
            rtone_freq = "88.5"
            ctone_freq = "88.5"
            dtcs_code = "023"
            ...
            formatted_row = {
                ...
                "Mode": "FM",  # UV-5R only supports FM
                "TStep": tstep,
                "Skip": "",
                "Comment": "",
                "URCALL": "",
