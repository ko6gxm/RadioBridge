...
class TestBaofengDM32UVFormatter:
        ...
        input_data = pd.DataFrame(
            {
                ...
                "Uplink": ["146.520000", "442.000000"],  # Simplex, repeater
                "Uplink Tone": ["123.0", ""],
    ...
    def test_dmr_detection_methods(self):
        ...
        for case in test_cases:
            ...
            expected_dmr = input_data.pop("expected_dmr").iloc[0]
    ...
    def test_color_code_detection(self):
        ...
        for case in test_cases:
            input_data = pd.DataFrame(case)
            expected_cc = input_data.pop("expected_cc").iloc[0]
    ...
    def test_dmr_id_detection(self):
        ...
        for case in test_cases:
            input_data = pd.DataFrame(case)
            expected_id = input_data.pop("expected_id").iloc[0]
    ...
    def test_channel_name_generation_and_conflicts(self):
        ...
        result = formatter.format(input_data)
        names = result["Channel Name"].tolist()
        ...
        input_data = pd.DataFrame(
            {
                ...
                "callsign": ["W6ABC", "EMPTY", "BAD", "K6XYZ"],
            }
        )
    ...
    def test_format_zones_band_strategy(self):
        ...
        input_data = pd.DataFrame(
            {
                "frequency": ["146.520", "147.000", "447.000", "448.000"],
                "callsign": ["W6VHF1", "W6VHF2", "W6UHF1", "W6UHF2"],
            }
        )
        ...
        assert len(zones) >= 2
        zone_names = zones["Zone Name"].tolist()
    ...
    def test_format_zones_large_channel_set(self):
        ...
        frequencies = [f"146.{520 + i:03d}" for i in range(70)]  # 70 channels
        callsigns = [f"W6T{i:02d}" for i in range(70)]
    ...
    def test_format_zones_fallback(self):
        ...
        empty_channels = pd.DataFrame(columns=["Channel Name", "No."])
